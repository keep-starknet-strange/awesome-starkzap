...
| MarketZap | A prediction market platform for creating and trading predictions on real-world events. Gasless, fully on-chain with Cartridge Controller and dark pool matching to prevent front-running. | [Repo](https://github.com/onlyoneAlexia/market-zap) | [Live Demo](https://marketzap.app) |
