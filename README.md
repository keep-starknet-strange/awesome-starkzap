...
| ZapCode | Zapcode is a simple QR code payment system that lets businesses accept USDC on Starknet with just an email—no wallets, no gas fees, and no technical knowledge required, and also allows buyers make payments directly on the platform, all fees sponsored. | [Repo](https://github.com/OkoliEvans/zapcode) | [Live Demo](https://zapcodex.netlify.app/) |
