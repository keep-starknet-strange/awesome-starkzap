...
| StarkPass | A privacy-first event pass that lets users prove eligibility with zero-knowledge proofs and enter events on Starknet without revealing personal data. | [Repo](https://github.com/dumprahul/starkpass) | [Live Demo](https://youtu.be/9r69H01GaBs) |
