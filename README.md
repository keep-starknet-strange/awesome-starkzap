...
| Trust Meet | Trust Meet solves the trust problem when meeting strangers in real life. Users create a meeting, stake USDC, and select a venue on the map. Participants who attend and check in receive their stake back, while no-shows automatically lose their stake, which is redistributed to attendees. | [Repo](https://github.com/Shadow-Ash/trust-meet) | [Live Demo](https://trust-meet.vercel.app/) |
