...
| Obscura | Private strkBTC payment layer on Starknet. Shielded pool with zero-event transfers, social login via Privy, and gasless transactions via AVNU Paymaster. No seed phrases. No gas fees. | [Repo](https://github.com/MITCHYUGAN/Obscura-frontend) | [Live Demo](https://obscura-frontend.vercel.app) |
