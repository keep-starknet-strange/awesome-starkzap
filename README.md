...
| Fund-Flow | Fund Flow is a social fundraising platform where communities create yield-generating treasuries/circle for events( let say if we friends are planning a trip after 4 months, or for parties and birthdays) and can create private prediction markets in their circle. Markets can be oracle based like will India win today's match or non-oracle like who will abuse in the trip first  | [Repo](https://github.com/chandanjha34/Fund-Flow) | [Live Demo](https://fund-flow-wine.vercel.app/) |
