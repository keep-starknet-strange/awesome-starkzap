...
| Dare Board | Post dares publicly, lock token rewards in escrow, submit proof, and let the community vote to release or refund — fully gasless on Starknet. | [Repo](https://github.com/UtkarshArjariya/Starkzap) | [Live Demo](https://dare-board.utkarsharjariya.xyz/) |
